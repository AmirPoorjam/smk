...
if __name__ == '__main__':
    ...
    for irx in range(itr):
        ...
        lr_model = LogisticRegression(solver='liblinear',class_weight='balanced', max_iter=1000).fit(training_features,training_labels)
        ...
        predicted_labels = lr_model.predict(test_features)
        probability_prediction = lr_model.predict_proba(test_features)
    ...
    # plt.ylabel('precision')
    # plt.subplot(3, 2, 3)
    # plt.scatter(accuracy, fscore)
    # plt.xlabel('Overall Accuracy')
    # plt.ylabel('F Score')
    # plt.subplot(3, 2, 4)
    # plt.scatter(accuracy, auc0)
    # plt.xlabel('Overall Accuracy')
    # plt.ylabel('AUC')
    # plt.subplot(3, 2, 5)
    # plt.scatter(precision, auc0)
    # plt.xlabel('Precision')
    # plt.ylabel('AUC')
    # plt.subplot(3, 2, 6)
    # plt.scatter(recall, auc0)
    # plt.xlabel('Recall')
    # plt.ylabel('AUC')
    # plt.show()
...
# To check the correlation between different metrics
    # from scipy import stats
    # acc_acc5 = stats.pearsonr(accuracy_top5p,accuracy)
    # auc1_acc5 = stats.pearsonr(accuracy_top5p, auc1)
    # auc0_acc5 = stats.pearsonr(accuracy_top5p, auc0)
    # precision_acc5 = stats.pearsonr(accuracy_top5p, precision)
    # recall_acc5 = stats.pearsonr(accuracy_top5p, recall)
    # fscore_acc5 = stats.pearsonr(accuracy_top5p, fscore)
    # print(acc_acc5[0],auc0_acc5[0],auc1_acc5[0],precision_acc5[0],recall_acc5[0],fscore_acc5[0])
