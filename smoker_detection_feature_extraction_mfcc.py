...
destinationfolder = 'C:/Amir/Codes/smoker detection/features_mfcc/'
...
for filename in all_files:
    ...
    if gender_spk_a=='nan' or smoke_spk_a=='nan':
        ...
        if maxamp_a != 0:
            ...
            mfcc_features, _, _ = fe.main_mfcc_function(norm_sig_a, fs, MFCCParam)
    ...
    if gender_spk_b=='nan' or smoke_spk_b=='nan':
        ...
        if maxamp_b != 0:
            ...
            mfcc_features, _, _ = fe.main_mfcc_function(norm_sig_b, fs, MFCCParam)
